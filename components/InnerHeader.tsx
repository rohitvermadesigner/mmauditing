...
function InnerHeader({ backgroundImage = "/images/hero-banner.webp", title, subtitle }: InnerHeaderProps) {
  return (
    ...
    >
      <div className="relative max-w-7xl mx-auto py-16 md:py-36 px-4 md:px-0">
        <div className="flex flex-col items-center justify-center text-center text-white">
          ...
          {subtitle && (
            <p className="text-base md:text-base [text-shadow:0_4px_10px_rgba(0,0,0,0.5)] drop-shadow-[2px_4px_10px_rgba(0,0,0,0.5)] md:px-48">
              {subtitle}
            </p>
          )}
        </div>
